...
define('TEMPL_FRAMWORK_ZIP_FOLDER_PATH','http://templatic.com/updates/admin.zip');
define('TEMPL_FRAMWORK_CURRENT_VERSION','1.0.0');
define('TT_FRAMEWORK_FOLDER_PATH',TT_ADMIN_FOLDER_PATH);

include_once(TT_ADMIN_FOLDER_PATH.'admin_menu.php');
if(get_option('ptthemes_use_third_party_data')=='No' && get_option('pttheme_seo_hide_fields')=='No')
{
