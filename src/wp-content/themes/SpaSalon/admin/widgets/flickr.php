...
if(!class_exists('templ_flickr'))
{
	class templ_flickr extends WP_Widget {
		...
		//Constructor
			$widget_ops = array('classname' => 'widget flickr_photos ', 'description' => apply_filters('templ_flickr_widget_desc_filter','Enter your Flickr ID to display photos from Flickr') );
