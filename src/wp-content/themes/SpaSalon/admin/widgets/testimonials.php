...
class templ_testimonials_widget extends WP_Widget {
	...
	//Constructor
		$widget_ops = array('classname' => 'widget testimonials', 'description' => apply_filters('templ_testimonial_widget_desc_filter','Testimonials Widget to display customer testimonials on your site') );		
	...
	// prints the widget 
		...
		$fadin = empty($instance['fadin']) ? '1000' : $instance['fadin'];
		$fadout = empty($instance['fadout']) ? '5000' : $instance['fadout'];
...
<p><label for="<?php echo $this->get_field_id('fadin'); ?>"><?php _e('Set Fade-in time (in seconds):','templatic');?> <input class="widefat" id="<?php echo $this->get_field_id('fadin'); ?>" name="<?php echo $this->get_field_name('fadin'); ?>" type="text" value="<?php echo attribute_escape($fadin); ?>" /></label></p>
<p><label for="<?php echo $this->get_field_id('fadout'); ?>"><?php _e('Set Fade-out time (in seconds):','templatic');?> <input class="widefat" id="<?php echo $this->get_field_id('fadout'); ?>" name="<?php echo $this->get_field_name('fadout'); ?>" type="text" value="<?php echo attribute_escape($fadout); ?>" /></label></p>
