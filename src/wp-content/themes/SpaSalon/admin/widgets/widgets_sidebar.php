...
///----------------------------------------------------------------
	...
	$sidebar_widget_arr['header_logo_right_side'] =array(1,array('name' => __('Header : Right area','templatic'),'id' => 'header_logo_right_side','before_widget' => '<div class="widget">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));

///-----------------------------------------------------------------
	  //  SLIDER SECTION WIDGET AREAS  //
///----------------------------------------------------------------

	$sidebar_widget_arr['home_slider'] =array(1,array('name' => __('Homepage : Slider','templatic'),'id' => 'home_slider','before_widget' => '<div class="widget">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
...
///----------------------------------------------------------------
	...
	$sidebar_widget_arr['sidebar_2col_merge'] =array(1,array('name' => __('Sidebar : 2 column Merge','templatic'),'id' => 'sidebar_2col_merge','before_widget' => '<div class="widget">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));

///-----------------------------------------------------------------
	  //  FOOTER SECTION WIDGET AREAS  //
///----------------------------------------------------------------

	$sidebar_widget_arr['footer1'] =array('1',array('name' => __('Footer : First Widget','templatic'), 'id' => 'footer1', 'before_widget' => '<div class="widget">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
	
	$sidebar_widget_arr['footer2'] =array('1',array('name' => __('Footer : Second Widget','templatic'), 'id' => 'footer2', 'before_widget' => '<div class="widget">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
	
	$sidebar_widget_arr['footer3'] =array('1',array('name' => __('Footer : Third Widget','templatic'), 'id' => 'footer3', 'before_widget' => '<div class="widget">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
	
	$sidebar_widget_arr['footer4'] =array('1',array('name' => __('Footer : Fourth Widget','templatic'), 'id' => 'footer4', 'before_widget' => '<div class="widget">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
