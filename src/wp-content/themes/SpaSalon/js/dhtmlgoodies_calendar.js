...
function writeCalendarContent()
{
	...
	for(var no=1;no<=daysInMonth;no++){
		...
		}else if(currentMonth < inputMonth && no > tmpDayd  && currentYear <= inputYear || currentMonth <= inputMonth && no < tmpDayd  && currentYear <= inputYear || currentMonth <= inputMonth && no == tmpDayd  && currentYear <= inputYear){
...
function displayCalendar(inputField,format,buttonObj)
{
	...
	while(t.parentNode){
	if( t == document.getElementById('container1')||t == document.getElementById('calendarDiv')){
