...
//////////pay settings start////////
	...
	$payOpts[] = array(
					"title"			=>	__("Cuurency Code",'templatic'),
					"fieldname"		=>	"currency",
					"value"			=>	'USD',
					"description"	=>	'Enter Cuurency Code (Example : USD, EUR)',
					);
...
if($paymentinfo)
{
	...
	{
		echo '<a href="'.site_url().'/wp-admin/admin.php?page=Appointment&status=0&id='.$option_id.'#payment_setups">'.__('Deactivate','templatic').'</a>';
	}else
	{
		echo '<a href="'.site_url().'/wp-admin/admin.php?page=Appointment&status=1&id='.$option_id.'#payment_setups">'.__('Activate','templatic').'</a>';
	}
	?></td>
      <td><?php
    echo '<a href="'.site_url().'/wp-admin/admin.php?page=Appointment&payact=setting&id='.$option_id.'#payment_setups">'.__('Settings','templatic').'</a>';
	?></td>
      <td>&nbsp;</td>
    </tr>
