...
{
	$guidelink .= "/theme-documentation/spasalon-theme-guide"; // templatic.com site theme guide url here
	return $guidelink;
}
...
{
	$forumlink .= "/viewforum.php?f=73"; // templatic.com site Forum url here
	return $forumlink;
}
...
{
	return $content=__('SpaSalon','templatic');
}
...
/////////////////////////////////////////////////////
	...
	<a class="post_img" href="<?php echo get_permalink($post->ID);?>">
     <?php
			$img_size = bdw_get_images_with_info($post->ID,'slider-thumb');
			$post_images = $img_size[0]['file'];
		?>
	 <img src="<?php echo $post_images;?>" alt="<?php echo get_the_title($post->ID);?>" title="<?php echo get_the_title($post->ID);?>"  /></a>
	<?php } ?>
...
$sidebar_widget_arr['top_strip'] =array(1,array('name' => 'Top strip','id' => 'top_strip','before_widget' => '<div class="widget">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
$sidebar_widget_arr['index_page_sidebar'] =array(1,array('name' => 'Homepage : Sidebar','id' => 'index_page_sidebar','before_widget' => '<div class="widget">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
	$sidebar_widget_arr['index_page_content'] =array(1,array('name' => 'Homepage : Content','id' => 'index_page_content','before_widget' => '<div class="widget">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
	$sidebar_widget_arr['index_pre_footer_left'] =array(1,array('name' => 'Homepage : Pre-footer Left','id' => 'index_pre_footer_left','before_widget' => '<div class="widget">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
	$sidebar_widget_arr['index_pre_footer_right'] =array(1,array('name' => 'Homepage : Pre-footer Right','id' => 'index_pre_footer_right','before_widget' => '<div class="widget">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
	$sidebar_widget_arr['contact_form_bottom'] =array(1,array('name' => 'Contactpage : Form bottom','id' => 'contact_form_bottom','before_widget' => '<div class="widget">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
...
add_filter('templ_sidebar_widget_box_filter','templ_sidebar_widget_box_filter_fnc');
function templ_sidebar_widget_box_filter_fnc($info)
{
	$info['home_slider'][1]['name'] = __('Home Banner','templatic');
	return $info;
}
?>